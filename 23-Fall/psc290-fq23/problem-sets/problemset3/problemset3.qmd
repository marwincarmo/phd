...
df_school_all %>%
  ...
  select(state_code, school_type, total_students, n_student_race, race, pct) %>% 
  group_by(state_code, school_type) %>%
  mutate(total_students_state = sum(total_students)) %>%
  group_by(state_code, school_type, race) %>%
  summarise(pct_race_state = sum(n_student_race))
  summarise(pct_race_state = sum(n_student_race)/total_students_state)
