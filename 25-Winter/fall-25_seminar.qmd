...
- **Limitations**. Assumes a fixed within-school standard variance, potentially masking important differences in variability:
  - Teaching quality
  - Socioeconomic influnences
  - Student engagement

::: {.notes}
These differences in variability can reflect underlying factors such as teaching quality, socioeconomic influences, or student engagement.
:::
