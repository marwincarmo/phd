...
To address the second research question—whether initial levels of auxiliary psychological variables predict the rate of change in insomnia severity—a series of Latent Growth Curve Models (LGCMs) were specified within a Structural Equation Modeling (SEM) framework. By treating the initial level (intercept) and rates of change (slopes) as latent variables, LGCM can directly test if these growth factors are significantly predicted by baseline characteristics.
