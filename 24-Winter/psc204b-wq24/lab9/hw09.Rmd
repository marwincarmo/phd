...
* Intercept: The intercept tell us that 10.03 is the expected score on the preliminary exam when the GRE verbal score and the need for achievement are at its mean value.
* Coefficient for `grev`: Holding need for achievement constant, we expect that preliminary exam increase by 0.45  units for a one standard deviation change in GRE Verbal scores.
* Coefficient for `ach`: Holding GRE Verbal scores constant, we expect that preliminary exam increase by 0.32  units for a one standard deviation change in need for achievement scores.
...
* Answer: The 95% confidence interval of the difference between the of the 1000 simulated regression coefficients does not contain zero. This suggest us the difference between the two should be greater than zero, supporting the initial conclusions.
...
* Answer: The 95% confidence intervals obtained by simulation are very close in value to those obtained by bootstrapping the differences. Either of those tell us that the difference between slopes is larger than zero more than 95% of the times.
