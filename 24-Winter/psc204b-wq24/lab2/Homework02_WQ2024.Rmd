...
mod3 <- lm(CESD ~ O + C + N, data = hw2_std)
summary(mod3)
...
$$\widehat{\text{Stress}}_i = ??, \quad \text{when sex = 0}$$

$$\widehat{\text{Stress}}_i = ??, \quad \text{when sex = 1}$$
