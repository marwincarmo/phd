...
:::fragment
![](img/partial_diagram.png){fig-align="center" width=80%}
:::
...
:::fragment
![](img/moderation.png){fig-align="center" width=80%}
:::
...
:::fragment
```{r, echo=TRUE}
literacy_interaction = lm(OverallLiteracy ~ ChildAge_c * ParentChildAct_c, data = reading)
```
