---
title: "Lab 3: Multiple Regression"
...
```{r, echo=TRUE}
reading <- read.csv("https://raw.githubusercontent.com/marwincarmo/phd/main/24-Winter/psc103b-wq24/lab/data/Lab3Data.csv")
```
...
0.26], *t*(148) = 7.18, *p* < .001).]{color=#b22222}
...
[0.11, 0.31], *t*(148) = 4.24, *p* < .001). Parent-child activity explained 11% of the total variability in child reading literacy.]{color=#b22222}
