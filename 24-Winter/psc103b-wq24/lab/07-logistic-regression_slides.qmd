...
by a factor of (are multiplied by) exp(1.06) = 2.89, or a 289% increase in the odds.
...
- The odds of it being rated good are exp(.24) = 1.27
...
- Let's interpret these in terms of the odds
