...
for agreeableness for cat people vs. dog people in our dataset.
...
The way to tell R this is to use the following statement: `fave_animal != "other"`
...
You can also group by more than one grouping variable. I'll make one from one of our continuous variables: extraversion (We haven't learned how to do this yet, so don't worry
...
We can create an interval around our mean. If we compute a 95% CI this only tells us that roughly 95%
