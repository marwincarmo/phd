...
- The Gelman and Rubins scale reduction factor $\hat{R}$ was < 1.1 for all parameters. This ensures that all samples mixed well and sampled from the typical set.
